...
def get_date(date_and_time: str) -> str:
    ...
    if type(date_and_time) != str or len(date_and_time) != 26:
    ...
    if (any([not digits_str.isdigit(), date_and_time[4] != "-",
    date_and_time[7] != "-", date_and_time[10] != "T",
    date_and_time[13] != ":", date_and_time[16] != ":",
    date_and_time[19] != "."])):
        raise ValueError("Неправильный формат даты")
