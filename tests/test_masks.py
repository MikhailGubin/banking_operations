...
@pytest.mark.parametrize("card_number", [("70007922896063611258"),
                                         ("1234"),
                                         ("")])
...
@pytest.mark.parametrize("account_number", [(["70007922896063614759"]),
                                            ({"123456789 0111213569"}),
                                            (True)])
...
@pytest.mark.parametrize("account_number", [("7365410843013587430556"),
                                            ("1234567569"),
                                            ("")])
